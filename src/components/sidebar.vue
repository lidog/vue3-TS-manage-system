        ...
        <el-menu class="sidebar-el-menu" :default-active="onRoutes" :collapse="sidebar.collapse" background-color="#324157"
            ...
            <template v-for="item in items">
                <template v-if="item.subs">
                    <el-sub-menu :index="item.index" :key="item.index" v-premiss="item.premiss">
                        <template #title>
                            <el-icon>
                ...
                <template v-else>
                    <el-menu-item :index="item.index" :key="item.index" v-premiss="item.premiss">
                        <el-icon>
                            <component :is="item.icon"></component>
                        </el-icon>
